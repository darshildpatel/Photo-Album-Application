...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = '<Enter your API Gateway invoke URL>';
    ...
    apigClient.photosPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Access-Control-Allow-Origin', 'Accept', 'Access-Control-Allow-Headers', 'Control-Type', 'Access-Control-Allow-Methods'], ['body']);
        ...
        var photosPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Access-Control-Allow-Origin', 'Accept', 'Access-Control-Allow-Headers', 'Control-Type', 'Access-Control-Allow-Methods']),
    ...
    apigClient.photosItemPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['item', 'Accept', 'Content-Type'], ['body']);
        ...
        var photosItemPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Accept', 'Content-Type']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
